...
{
    protected $fillable = ['gc_id','gc_event_title', 'gc_address', 'gc_event_begins', 'gc_event_ends', 'gc_description', 'gc_team', 'name', 'phone_no', 'status', 'receipt_number', 'invoice_number', 'price', 'service_type',];
    ...
    public function getCustomerName()
    {
        ...
        $name = Booking::select('gc_description')->where('id', $this->id)->get();
    ...
    public function getPhoneNumber()
    {
        ...
        $phone = Booking::select('gc_description')->where('id', $this->id)->get();
